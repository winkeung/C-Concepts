...
Also some CPU may require 4-byte integer to be stored beginning at 4-byte boundary. For example at address 0xf1348074 but not at 0xf1348071 (must be divisible by 4). So type casting a pointer to any byte in a char[] array to a int* pointer may cause error.  
