...
Noted that the black marks (taller one) are affected by the how big and small the number exp field can represent, the number of blue marks between black marks is affected by number of bits in fraction field.
